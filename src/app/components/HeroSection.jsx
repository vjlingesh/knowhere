      ...
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        ...
        >
          ...
          <div>
            ...
            <button className='px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500  bg-transparent hover:bg-slate-800 text-white border border-white mt-3'>
